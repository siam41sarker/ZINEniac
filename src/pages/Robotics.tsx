  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-20 relative overflow-hidden">
        ...
        <div className="bg-gradient-to-br from-fun-blue/20 via-fun-green/15 to-fun-purple/10 py-16">
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                <div className="inline-block bg-primary/10 rounded-full px-5 py-2 mb-4">
                  <span className="text-primary font-bold text-sm">🤖 Build the Future</span>
                </div>
