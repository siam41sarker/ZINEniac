            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                <div className="inline-block bg-primary/10 rounded-full px-5 py-2 mb-4">
                  <span className="text-primary font-bold text-sm">☀️ Summer Fun</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4">
                  ZINEniac's <span className="text-primary">Summer Camps</span>
                </h1>
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="bg-card rounded-3xl p-10 shadow-sm border-2 border-fun-yellow/20 mb-10">
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Elevate your summer with ZINEniac's immersive Summer Camps! Picture real-life applications, hands-on experiences, and a global community fostering diverse perspectives.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Our meticulously curated programs cover STEAM, language enrichment, and more, catering to various interests and age groups. Experience interactive lessons that make learning enjoyable, with multimedia elements and real-world scenarios.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed">
              Don't miss this extraordinary opportunity for growth, friendship, and limitless possibilities – enroll now at ZINEniac's Summer Camps!
            </p>
          </div>
